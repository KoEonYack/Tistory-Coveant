...
Spring Cloud Gateway를 이용하여 API 게이트웨이 구성 및 유레카 서버 연동
...
<br />
<img src="./img/service-discovery.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
<br />
<img src="./img/gateway-msa.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />

본 글에서는 스프링 클라우드 게이트웨이(Spring Cloud Gateway)를 이용하여 클라이언트는 스프링 게이트웨이를 통해서 URL을 호출하면 스프링 게이트웨이가 벡엔드 애플리케이션을 조회하여 클라이언트에 응답하도록 하겠습니다.
...
<br />
<br />
<img src="./img/client-direct-call.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />

게이트웨이를 사용하지 않으면 다양한 문제를 만나게됩니다. 간단한 사례를 보겠습니다. 만약 클라이언트에서 마이크로서비스를 직접 호출한다고 가정해봅시다.

<br />
<img src="./img/client-direct-call-problem.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
<br />
<img src="./img/api-gateway.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
<center> 
...
모든 요청은 우선 게이트웨이를 통하게되므로 로그 처리에 용의합니다.
...
<br />
<img src="./img/gateway-msa-example.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
- __(2):__ 클라이언트에서 로그인 요청이 API 게이트로 옵다.
- __(3,4):__ API 게이트웨이에서 받은 로그인 요청을 어떤 인스턴스에서 처리할 수 있을지 서비스 디스커버리에서 찾습니다.
...
<br />
<img src="./img/dependency.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
<center>
인텔리제이 dependency 선택
</center>
...
스크린샷에는 롬복이 있지만 본 예제에서는 사용하지 않을 예정입니다. (* 앞서 게이트웨이에서 로깅 처리를 한다고도 하였습니다. 롬복을 추가하여 게이트웨이 필터에 로깅을 작업할 수 있습니다.)
...
- spring.application.name: 유레카 서버에 등록되는 서비스 명
- eureka.client.register-with-eureka: 유레카 디스커버리 서버의 등록을 위해 true로 설정합니다.
- eureka.client.fetch-registry: defaultZone의 유레카 서버에서 클라이언트 정보를 가져옵니다. false의 경우 정상 드록되지 않습니다.
...
- 라우트(Route): 응답을 보낼 목적지 URI, 필터 항목을 식별하기 위한 ID로 구성됩니다.
- 조건자(Predicate): 요청을 처리하기전 HTTP 요청이 정의된 조건에 부합하는지 검사합니다.
- 필터(Filter): 게이트웨이에서 받은 요청과 응답을 수정할 수 있습니다.
...
<br />
<img src="./img/register-instance.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
<br />
<img src="./img/eureka.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
<br />
<img src="./img/postman.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />

게이트웨이 주소를 호출했지만 성공적으로 스프링 서비스를 호출한 것을 확인할 수 있습니다.

<br />
<img src="./img/gateway-discover.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
...
<br />
<br />
<img src="./img/actuator.png?raw=true" align="center" style="display: block; margin: 0px auto; display: block; height: auto; border:1px solid #eaeaea; padding: 0px;" width="" >
<br />
<center>
캐싱된 routes 정보 확인
</center>
