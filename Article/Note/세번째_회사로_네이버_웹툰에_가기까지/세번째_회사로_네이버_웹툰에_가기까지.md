...
토스뱅크 CTO 면접이 있는 날 오전에 링크드인으로 웹툰 채용 소개 관련 메시지를 보내주신 네이버 웹툰 테크 리크루터와 전화 통화를 합니다. 

<br />

이미 네이버 웹툰은 직간접적으로 명성(?)을 들어서 익히 알고 있었으며, 작년에 네이버 웹툰의 채용 설명회 [회사에서 재미를 추구하면 안 되는 걸까 | 네이버 웹툰 개발자 채용설명회](https://www.youtube.com/watch?v=DiSTevbYRpc) 를 재미있게 봤었습니다. 중학교 때부터 이용하던 웹툰 서비스를 만들 수 있다는 생각에 지원합니다. 
